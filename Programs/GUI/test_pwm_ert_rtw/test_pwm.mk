###########################################################################
## Makefile generated for component 'test_pwm'. 
## 
## Makefile     : test_pwm.mk
## Generated on : Thu Jun 03 13:05:05 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test_pwm.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test_pwm.elf
...
DEFINES_STANDARD = -DMODEL=test_pwm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_digitalIO.c rtGetInf.c rtGetNaN.c rt_nonfinite.c test_pwm.c test_pwm_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_digitalIO.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o test_pwm.c.o test_pwm_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
test_pwm.c.o : test_pwm.c
	$(CC) $(CFLAGS) -o "$@" "$<"


test_pwm_data.c.o : test_pwm_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
